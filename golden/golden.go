...
//
// This package is forked from https://github.com/sebdah/goldie.
// Copyright 2016 Sebastian Dahlgren <sebastian.dahlgren@gmail.com>
// License: https://github.com/nao1215/sqly/tree/main/golden/LICENSE
package golden
...
func Diff(engine DiffEngine, actual string, expected string) (diff string) {
	...
	case ClassicDiff:
		...
		if err != nil {
			diff = fmt.Sprintf("Error generating diff: %s", err)
		}
