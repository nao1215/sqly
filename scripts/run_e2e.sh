...
if ! command -v atago >/dev/null 2>&1; then
	...
	echo "e2e: e.g. 'go install github.com/nao1215/atago@v0.21.0' (CI uses nao1215/setup-atago)" >&2
	exit 127
fi
...
# set their own SQLY_HISTORY_PATH still never touch the real history file.
