...
### Documentation
* README: the write-back section documents that a run changing no row writes no file, with the message it prints; `readme_examples.atago.yaml` runs that example against the binary.
